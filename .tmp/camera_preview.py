...
pointcloud_path = root / 'pointclouds' / 'Hydrant_vertical_point_cloud.ply'
character_path = root / 'characters' / 'doozy-hiphop.fbx'
output_path = root / 'doozy-hiphop_Hydrant_vertical_point_cloud_camera_preview.blend'
...
character_objects = mod.import_and_place_fbx(character_path, location=(0.0, -1.3, -1.5), rotation_deg=(90.0, 0.0, 0.0))
